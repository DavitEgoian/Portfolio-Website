...
const techLogos = [
  ...
  { src: anacondaLogo, alt: "Anaconda Logo" },
  { src: jupyterLabLogo, alt: "Jupyter Lab Logo" },
  { src: numpyLogo, alt: "NumPy Logo" },
  { src: pandasLogo, alt: "Pandas Logo" },
  { src: matplotlibLogo, alt: "Matplotlib Logo" },
  { src: scipySeekLogo, alt: "SciPy Logo" },
  { src: plotlyLogo, alt: "Plotly Logo" },
  ...
  { src: lightGMBLogo, alt: "LightGBM Logo" },
  ...
  { src: tableauLogo, alt: "Tableau Logo" }
];
